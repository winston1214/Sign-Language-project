...
file_data["original_frame"] = test_image
...
with open('/content/drive/MyDrive/BOAZ_수어프로젝트/Data/10481_12994_frame_openpose/'+test_image.rstrip('.jpg')+'_keypoint.json','w',encoding="utf-8") as make_file:
